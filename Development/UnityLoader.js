...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Profiler.data';
    var REMOTE_PACKAGE_BASE = 'Profiler.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 7981974;
      var PACKAGE_UUID = 'a772261f-b6fd-45a0-9e53-e726d100fc6e';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4075443, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4075443, 4075464, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4075464, 4075486, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(4075486, 4079497, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(4079497, 7079377, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(7079377, 7954349, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(7954349, 7981974, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Profiler.data');

    };
    Module['addRunDependency']('datafile_Profiler.data');
